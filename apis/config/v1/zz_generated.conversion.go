...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*CpuRealUsageArgs)(nil), (*config.CpuRealUsageArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_CpuRealUsageArgs_To_config_CpuRealUsageArgs(a.(*CpuRealUsageArgs), b.(*config.CpuRealUsageArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.CpuRealUsageArgs)(nil), (*CpuRealUsageArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_CpuRealUsageArgs_To_v1_CpuRealUsageArgs(a.(*config.CpuRealUsageArgs), b.(*CpuRealUsageArgs), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*MemRealUsageArgs)(nil), (*config.MemRealUsageArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_MemRealUsageArgs_To_config_MemRealUsageArgs(a.(*MemRealUsageArgs), b.(*config.MemRealUsageArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.MemRealUsageArgs)(nil), (*MemRealUsageArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_MemRealUsageArgs_To_v1_MemRealUsageArgs(a.(*config.MemRealUsageArgs), b.(*MemRealUsageArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_CpuRealUsageArgs_To_config_CpuRealUsageArgs(in *CpuRealUsageArgs, out *config.CpuRealUsageArgs, s conversion.Scope) error {
	if err := metav1.Convert_Pointer_string_To_string(&in.PrometheusApiAddr, &out.PrometheusApiAddr, s); err != nil {
		return err
	}
	if err := metav1.Convert_Pointer_int64_To_int64(&in.QueryMetricTimeSeconds, &out.QueryMetricTimeSeconds, s); err != nil {
		return err
	}
	if err := metav1.Convert_Pointer_int64_To_int64(&in.QueryMetricIntervalSeconds, &out.QueryMetricIntervalSeconds, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1_CpuRealUsageArgs_To_config_CpuRealUsageArgs is an autogenerated conversion function.
func Convert_v1_CpuRealUsageArgs_To_config_CpuRealUsageArgs(in *CpuRealUsageArgs, out *config.CpuRealUsageArgs, s conversion.Scope) error {
	return autoConvert_v1_CpuRealUsageArgs_To_config_CpuRealUsageArgs(in, out, s)
}

func autoConvert_config_CpuRealUsageArgs_To_v1_CpuRealUsageArgs(in *config.CpuRealUsageArgs, out *CpuRealUsageArgs, s conversion.Scope) error {
	if err := metav1.Convert_string_To_Pointer_string(&in.PrometheusApiAddr, &out.PrometheusApiAddr, s); err != nil {
		return err
	}
	if err := metav1.Convert_int64_To_Pointer_int64(&in.QueryMetricTimeSeconds, &out.QueryMetricTimeSeconds, s); err != nil {
		return err
	}
	if err := metav1.Convert_int64_To_Pointer_int64(&in.QueryMetricIntervalSeconds, &out.QueryMetricIntervalSeconds, s); err != nil {
		return err
	}
	return nil
}

// Convert_config_CpuRealUsageArgs_To_v1_CpuRealUsageArgs is an autogenerated conversion function.
func Convert_config_CpuRealUsageArgs_To_v1_CpuRealUsageArgs(in *config.CpuRealUsageArgs, out *CpuRealUsageArgs, s conversion.Scope) error {
	return autoConvert_config_CpuRealUsageArgs_To_v1_CpuRealUsageArgs(in, out, s)
}
...
func autoConvert_v1_MemRealUsageArgs_To_config_MemRealUsageArgs(in *MemRealUsageArgs, out *config.MemRealUsageArgs, s conversion.Scope) error {
	if err := metav1.Convert_Pointer_string_To_string(&in.PrometheusApiAddr, &out.PrometheusApiAddr, s); err != nil {
		return err
	}
	if err := metav1.Convert_Pointer_int64_To_int64(&in.QueryMetricTimeSeconds, &out.QueryMetricTimeSeconds, s); err != nil {
...
// Convert_v1_MemRealUsageArgs_To_config_MemRealUsageArgs is an autogenerated conversion function.
func Convert_v1_MemRealUsageArgs_To_config_MemRealUsageArgs(in *MemRealUsageArgs, out *config.MemRealUsageArgs, s conversion.Scope) error {
	return autoConvert_v1_MemRealUsageArgs_To_config_MemRealUsageArgs(in, out, s)
}

func autoConvert_config_MemRealUsageArgs_To_v1_MemRealUsageArgs(in *config.MemRealUsageArgs, out *MemRealUsageArgs, s conversion.Scope) error {
	if err := metav1.Convert_string_To_Pointer_string(&in.PrometheusApiAddr, &out.PrometheusApiAddr, s); err != nil {
		return err
	}
	if err := metav1.Convert_int64_To_Pointer_int64(&in.QueryMetricTimeSeconds, &out.QueryMetricTimeSeconds, s); err != nil {
...
// Convert_config_MemRealUsageArgs_To_v1_MemRealUsageArgs is an autogenerated conversion function.
func Convert_config_MemRealUsageArgs_To_v1_MemRealUsageArgs(in *config.MemRealUsageArgs, out *MemRealUsageArgs, s conversion.Scope) error {
	return autoConvert_config_MemRealUsageArgs_To_v1_MemRealUsageArgs(in, out, s)
}
