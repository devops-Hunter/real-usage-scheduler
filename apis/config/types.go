...
type CpuRealUsageArgs struct {

	metav1.TypeMeta
	PrometheusApiAddr string `json:"prometheusApiAddr,omitempty"`
	QueryMetricTimeSeconds int64 `json:"queryMetricTimeSeconds,omitempty"`
	QueryMetricIntervalSeconds int64 `json:"queryMetricIntervalSeconds,omitempty"`
}

// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object

type MemRealUsageArgs struct {
