...
import (
	"os"
	cpu_real_usage "sigs.k8s.io/scheduler-plugins/pkg/cpu-real-usage"
	"sigs.k8s.io/scheduler-plugins/pkg/mem_real_usage"
...
func main() {
	...
	command := app.NewSchedulerCommand(
		...
		app.WithPlugin(cpu_real_usage.Name, cpu_real_usage.New),
		app.WithPlugin(mem_real_usage.Name, mem_real_usage.New),
	)
